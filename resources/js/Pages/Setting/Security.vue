  ...
  <Settings>
    <div class="w-full pl-16 pr-8 py-16 h-full">
      <form @submit.prevent="save">
        ...
        <FormInput id="old_password" v-model="form.old_password" label="Old Password" :type="showPass.password ? 'text' : 'password'">
          <template #icon-right>
        ...
        <div class="flex justify-between">
          <FormInput id="new_password" v-model="form.new_password" :type="showPass.new_password ? 'text' : 'password'" label="New Password" class="w-[48%]">
            <template #icon-right>
          ...
          <FormInput id="confirm_new_password" v-model="form.confirm_new_password" :type="showPass.confirm_new_password ? 'text' : 'password'" label="Confirm New Password" class="w-[48%]">
            <template #icon-right>
