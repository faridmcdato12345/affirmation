      ...
      <div class="md:w-full md:pl-16 md:pr-8 md:py-16 h-full">
        <form @submit.prevent="save">
          ...
          <textarea
            ...
            class="border-2 border-green-700 w-full rounded-md px-3 dark:bg-gray-800/60 py-2"></textarea>
        ...
        <form class="mt-8" @submit.prevent="sendFeedback">
          ...
          <textarea
            ...
            class="border-2 border-green-700 w-full rounded-md px-3 py-2 dark:bg-gray-800/60"></textarea>
