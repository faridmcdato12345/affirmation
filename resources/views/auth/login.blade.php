                        ...
                        <div class="card-center">
                            <div class="ps-5 pe-5">
                                ...
                                <div class="input-style no-borders has-icon validate-field">
                                    ...
                                    <input type="email"
                                        class="form-control validate-email @error('password') is-invalid @enderror"
                                ...
                                <div class="input-style no-borders has-icon validate-field mt-4">
                                    ...
                                    <input type="password" class="form-control validate-password" id="password"
                                ...
                                <div class="d-flex mt-4 mb-4">
                                    ...
                                    @if (Route::has('password.request'))
                                        <div class="w-50 font-11 pb-2 text-end"><a
                                                href="{{ route('password.request') }}">Forgot Credentials</a></div>
                                    @endif
                                </div>

                                <button type="submit"
                                    class="back-button btn btn-full btn-m shadow-large rounded-sm text-uppercase font-700 bg-highlight mx-auto">LOGIN</button>
                            </div>
                        </div>
                    </form>
                </div>
